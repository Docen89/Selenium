...
public class demoqa_browser_windows {
 ...
 @Test
   ...
   WebElement element_Alerts = driver.findElement(
       By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div[3]"));
   element_Alerts.click();
   WebElement element_Browser_Windows = driver.findElement(
       By.xpath("/html/body/div[2]/div/div/div/div[1]/div/div/div[3]/div/ul/li[1]"));
